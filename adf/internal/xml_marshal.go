...
type XMLMarshaler interface {
	...
	MarshalToXML(node adf.Node) ([]byte, error)
	...
	UnmarshalFromXML(data []byte, nodeType string) (adf.Node, error)
...
// MarshalToXML converts an ADF node to XML representation
func (m *DefaultXMLMarshaler) MarshalToXML(node adf.Node) ([]byte, error) {
	switch node.Type {
	case "expand":
...
func (m *DefaultXMLMarshaler) marshalExpandNode(node adf.Node) ([]byte, error) {
...
func (m *DefaultXMLMarshaler) marshalMentionNode(node adf.Node) ([]byte, error) {
...
func (m *DefaultXMLMarshaler) marshalTaskListNode(node adf.Node) ([]byte, error) {
...
func (m *DefaultXMLMarshaler) marshalTaskItemNode(node adf.Node) ([]byte, error) {
	taskItem := TaskElement{
		XMLName: xml.Name{Local: "taskItem"},
	}
...
func (m *DefaultXMLMarshaler) marshalHardBreakNode(node adf.Node) ([]byte, error) {
...
// UnmarshalFromXML converts XML data back to ADF node
func (m *DefaultXMLMarshaler) UnmarshalFromXML(data []byte, nodeType string) (adf.Node, error) {
	switch nodeType {
	case "expand":
...
func (m *DefaultXMLMarshaler) unmarshalExpandNode(data []byte) (adf.Node, error) {
	var expand ExpandElement
	if err := xml.Unmarshal(data, &expand); err != nil {
		return adf.Node{}, fmt.Errorf("failed to unmarshal expand element: %w", err)
	}
	...
	if expand.Content != "" {
		...
		node.Content = []adf.Node{paragraphNode}
	}
...
func (m *DefaultXMLMarshaler) unmarshalMentionNode(data []byte) (adf.Node, error) {
	var mention MentionElement
	if err := xml.Unmarshal(data, &mention); err != nil {
		return adf.Node{}, fmt.Errorf("failed to unmarshal mention element: %w", err)
	}
...
func (m *DefaultXMLMarshaler) unmarshalTaskListNode(data []byte) (adf.Node, error) {
	var taskList TaskListElement
	if err := xml.Unmarshal(data, &taskList); err != nil {
		return adf.Node{}, fmt.Errorf("failed to unmarshal task list element: %w", err)
	}
	...
	for _, taskElement := range taskList.Children {
		...
		if content != "" {
			...
			taskItemNode.Content = []adf.Node{paragraphNode}
		}
...
func (m *DefaultXMLMarshaler) unmarshalTaskItemNode(data []byte) (adf.Node, error) {
	var taskItem TaskElement
	if err := xml.Unmarshal(data, &taskItem); err != nil {
		return adf.Node{}, fmt.Errorf("failed to unmarshal task item element: %w", err)
	}
...
func (m *DefaultXMLMarshaler) unmarshalHardBreakNode(data []byte) (adf.Node, error) {
	var hardBreak HardBreakElement
	if err := xml.Unmarshal(data, &hardBreak); err != nil {
		return adf.Node{}, fmt.Errorf("failed to unmarshal hard break element: %w", err)
	}
...
func (m *DefaultXMLMarshaler) unmarshalGenericNode(data []byte) (adf.Node, error) {
	var generic GenericADFElement
	if err := xml.Unmarshal(data, &generic); err != nil {
		return adf.Node{}, fmt.Errorf("failed to unmarshal generic element: %w", err)
	}
...
func (m *DefaultXMLMarshaler) convertParagraphToMarkdown(paragraph adf.Node) string {
