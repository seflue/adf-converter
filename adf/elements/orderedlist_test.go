						...
						Content: []adf.Node{
							{
								Type: adf.NodeTypeParagraph,
								Content: []adf.Node{
									{Type: adf.NodeTypeText, Text: "First"},
								},
							},
						},
					},
						...
						Content: []adf.Node{
							{
								Type: adf.NodeTypeParagraph,
								Content: []adf.Node{
									{Type: adf.NodeTypeText, Text: "Second"},
								},
							},
						},
					},
						...
						Content: []adf.Node{
							{
								Type: adf.NodeTypeParagraph,
								Content: []adf.Node{
									{Type: adf.NodeTypeText, Text: "Third"},
								},
							},
						},
					},
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if node.Type != adf.NodeTypeOrderedList {
				t.Errorf("FromMarkdown() node type = %v, want %v", node.Type, adf.NodeTypeOrderedList)
			}
					...
					Content: []adf.Node{
						{
							...
							Content: []adf.Node{
								{
									Type:    adf.NodeTypeParagraph,
									Content: []adf.Node{{Type: adf.NodeTypeText, Text: "First"}},
								},
							},
						},
						{
							...
							Content: []adf.Node{
								{
									Type:    adf.NodeTypeParagraph,
									Content: []adf.Node{{Type: adf.NodeTypeText, Text: "Second"}},
								},
							},
						},
					},
