...
func (dlc *DefaultLinkClassifier) DetermineStrategy(classification LinkClassification) converter.ConversionStrategy {
...
func (dlc *DefaultLinkClassifier) ClassifyLinkFromADFMark(mark adf_types.ADFMark) (LinkClassification, converter.ConversionStrategy) {
